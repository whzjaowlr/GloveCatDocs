...
| Trading execution | Safe `openTrading()` executed on 2026-06-29 13:30:07 UTC |
...
reward-pool or current readiness evidence. The 1,000,000 GCAT and 4,000,000 GCAT staking funding
transactions are listed in [Public Evidence Links](/admin/contracts#public-evidence-links).

Use [Operational Status](/guide/operational-status) for the mutable readiness decision and pool
balance. If that source cannot provide a schema-valid observation no more than 60 seconds old,
